                        ...
                        <form action="{{ route('user.PostUpdatetUser') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9"><input type="text" id="masosv" class="form-control" name="masosv"
                                            value="{{ $user->masosv }}" required autofocus></div>
                                </div>

                                @if ($errors->has('masosv'))
                             ...
                             <div class="form-group mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9"><input type="text" id="masosv" class="form-control" name="sothich"
                                            value="{{ $user->sothich }}" required autofocus></div>
                                </div>
